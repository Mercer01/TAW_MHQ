...
switch (toLower typeOf _obj) do {
	case (toLower "B_Truck_01_transport_F"): {
		_composition = [['Land_BagFence_01_long_green_F',[-1.677,5.619,0],180.961],['Land_BagFence_01_long_green_F',[0.676,4.705,0],225.704],['Land_BagFence_01_long_green_F',[2.669,2.662,0],225.704],['Land_BagFence_01_long_green_F',[4.519,0.551,0],52.293],['Land_BagFence_01_long_green_F',[5.762,-2.053,0],79.959],['Land_BagFence_01_long_green_F',[6.259,-4.922,0],81.15],['Land_BagFence_01_long_green_F',[5.224,-7.217,0],142.442],['Land_BagFence_01_long_green_F',[2.714,-8.891,0],154.159],['Land_BagFence_01_long_green_F',[0.287,-10.500,0],137.708],['Land_BagFence_01_long_green_F',[-2.171,-10.984,0],194.797],['Land_BagFence_01_long_green_F',[-4.338,-9.500,0],241.344],['Land_BagFence_01_long_green_F',[-5.366,-6.830,0],258.166],['CamoNet_BLUFOR_F',[0.459,-0.353,0.506],44.294],['CamoNet_BLUFOR_F',[0.433,-6.244,0.31],141.213],['Land_TTowerSmall_2_F',[-2.503,-3.291,0],288.394],['B_CargoNet_01_ammo_F',[-3.466,0.518,0],55.368],['Misc_Backpackheap',[-5.577,0.131,0],175.101],['CargoNet_01_barrels_F',[-4.866,1.645,0],35.007]];
